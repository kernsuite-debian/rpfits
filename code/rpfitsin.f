...
C
C     $Id: rpfitsin.f,v 1.47 2011/03/21 00:17:07 cal103 Exp $
C-----------------------------------------------------------------------
...
C     Scan through header, getting the interesting bits.
      ...
      do 2500 while (.not.endhdr)
         ...
         version = ' '
         do 2400 i = 1, 32
C           Parse the RPFITS keyword and keyvalue.
            keyword  = m(i)(1:8)
